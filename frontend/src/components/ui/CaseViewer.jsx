...
const CaseSection = ({ section, data }) => {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
      <div className="flex items-center gap-2 px-6 py-4 bg-gradient-to-r from-teal-50 to-cyan-50 border-b border-teal-100">
  ...
  <div className="flex-1 space-y-4">
    ...
    <div className="bg-white rounded-xl border border-gray-100 shadow-sm px-8 py-6">
      ...
      <p className="text-sm text-gray-500 mt-1">
        ...
        {caseData.dificultad && (
          <span
            className="ml-2 inline-block px-2 py-0.5 rounded-full bg-teal-50 
